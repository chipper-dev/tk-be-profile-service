...
public class ProfileController extends CommonResource {
	...
	public String index(HttpServletRequest request) {
		...
		return "Hello from Profile Service in kondangan running at port: " + env.getProperty("local.server.port")
				+ ", with token " + token + " and userId : " + userId;
	}
...
//	public ResponseEntity<ResponseBody> registerUser(@RequestBody CreateProfileWrapper wrapper,
//			HttpServletRequest request) {
//		profileService.create(wrapper);
//		return ResponseEntity.ok(
//				getResponseBody(HttpStatus.OK.value(), "Your profile created successfully", request.getRequestURI()));
//	}
}
